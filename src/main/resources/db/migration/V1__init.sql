...
(
    ...
    STATUS_USER_ID                 VARCHAR(100),
    STATUS_ON_BEHALF_OF_USER_ID                 VARCHAR(100),
    STATUS_FIRST_NAME                 VARCHAR(500),
    STATUS_LAST_NAME                 VARCHAR(500),
    STATUS_USER_ORG                 VARCHAR(500),
    JUSTIFICATION                     TEXT
);
