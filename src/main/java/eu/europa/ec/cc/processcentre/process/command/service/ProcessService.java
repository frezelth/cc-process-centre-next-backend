...
public class ProcessService {
  ...
  private final ProcessTitleService processTitleService;
  ...
  public ProcessService(
      ...
      TranslationQuery translationQuery, ProcessTitleService processTitleService) {
    ...
    this.processTitleService = processTitleService;
  }
  ...
  public void updateProcessConfiguration(UpdateProcessContext command){
    ...
    processTitleService.updateProcessTitle(command.getProcessInstanceId());
